...
- 翻译支持多引擎：OpenAI 兼容 Chat Completions API，以及只需填写 AK/SK 的火山翻译；设置中点击左侧引擎卡片查看配置，点击卡片内「启用」按钮切换当前唯一使用的引擎；语言方向自动判断，简体中文译为英文，其他语言译为简体中文，文本会发送到对应服务端；复制原文或译文成功后会通过公共 Message 组件显示轻量提示
